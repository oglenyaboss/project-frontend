...
const ROUTE_NAME = "agent/sessions/start/context";
...
/**
 * BFF API Route: Start Agent Session with Context
 * POST /api/agent/sessions/start/context
 */
export async function POST(request: NextRequest) {
    try {
        ...
        const url = `${BACKEND_URL}/agent/sessions/start/context`;
        ...
        return NextResponse.json(
            {
                message: "Ошибка при запуске контекстной сессии агента",
