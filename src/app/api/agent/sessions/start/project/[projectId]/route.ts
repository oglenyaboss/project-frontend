...
const ROUTE_NAME = "agent/sessions/start/project";
...
/**
 * BFF API Route: Start Agent Session on Project
 * POST /api/agent/sessions/start/project/{projectId}
 */
export async function POST(request: NextRequest, { params }: RouteParams) {
    try {
        ...
        const url = `${BACKEND_URL}/agent/sessions/start/project/${projectId}`;
        ...
        return NextResponse.json(
            {
                message: "Ошибка при запуске сессии агента",
