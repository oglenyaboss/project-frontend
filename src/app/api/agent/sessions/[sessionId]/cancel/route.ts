...
const ROUTE_NAME = "agent/sessions/cancel";
...
/**
 * BFF API Route: Cancel Agent Session
...
export async function POST(request: NextRequest, { params }: RouteParams) {
    try {
        ...
        const url = `${BACKEND_URL}/agent/sessions/${sessionId}/cancel`;
        ...
        return NextResponse.json(
            {
                message: "Ошибка при отмене сессии",
