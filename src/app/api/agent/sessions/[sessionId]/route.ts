...
const ROUTE_NAME = "agent/sessions/[id]";
...
/**
 * BFF API Route: Get Agent Session
...
export async function GET(request: NextRequest, { params }: RouteParams) {
    try {
        ...
        const url = `${BACKEND_URL}/agent/sessions/${sessionId}`;
        ...
        return NextResponse.json(
            {
                message: "Ошибка при получении сессии агента",
