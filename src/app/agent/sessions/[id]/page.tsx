...
export default function AgentSessionPage({ params }: Props) {
    ...
    const isSessionComplete = sessionStatus === "done" || sessionStatus === "cancelled" || sessionStatus === "error";
            ...
            <header className="sticky top-0 z-50 glass border-b">
                <div className="container flex h-16 items-center justify-between px-4">
                    ...
                    <div className="flex items-center gap-2">
                        {/* Connection status */}
                        <div className={`flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium ${isConnected ? 'bg-green-500/10 text-green-600' : 'bg-yellow-500/10 text-yellow-600'
                            }`}>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            ...
                                            Процесс будет остановлен, и вы вернетесь в список проектов.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <div className="flex items-center gap-4">
                            <span className="text-muted-foreground">
                                Итерация: <span className="font-medium text-foreground">{currentIteration}/5</span>
                            </span>
                            <span className="text-muted-foreground">
                                Вопросов: <span className="font-medium text-foreground">{dialogue.length}</span>
                            </span>
                        </div>
                        <div className={`px-3 py-1 rounded-full text-xs font-medium ${sessionStatus === "done" ? "bg-green-100 text-green-700" :
                            sessionStatus === "waiting_for_answers" ? "bg-blue-100 text-blue-700" :
                                sessionStatus === "processing" ? "bg-yellow-100 text-yellow-700" :
                                    sessionStatus === "error" ? "bg-red-100 text-red-700" :
                ...
                <div className="grid gap-6">
                        ...
                        <div className="rounded-xl border bg-card p-6 shadow-premium animate-fade-in">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">Требования успешно сформированы</p>
                                </div>
                            </div>

                            {/* Preview of result */}
                            <div className="bg-muted/50 rounded-lg p-4 mb-4 max-h-48 overflow-auto">
                                <pre className="text-sm whitespace-pre-wrap">{result.content.slice(0, 500)}...</pre>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                <Button variant="outline" asChild>
                                    <a href={agentApi.exportRequirementUrl(result.requirement_id, 'docx')}>
                                        <Download className="mr-2 h-4 w-4" />
                                        DOCX
                                    </a>
                                </Button>
                                <Button variant="outline" asChild>
                                    <a href={agentApi.exportRequirementUrl(result.requirement_id, 'pdf')}>
                                        <Download className="mr-2 h-4 w-4" />
                                        PDF
                                    </a>
                                </Button>
                    ...
                    {sessionStatus === "error" && (
                        <Alert variant="destructive">
                            ...
                            <AlertDescription>
                                Произошла ошибка при обработке сессии. Попробуйте начать новую сессию.
                            </AlertDescription>
                        </Alert>
                    )}
                </div>
